...
const createSendToken = (user, statusCode, res) => {
  ...
  // Remove the password from the postman out put
...
exports.logout = (req, res) => {
  // Clear the cookie by setting an empty value and an immediate expiration.
  res.cookie('jwt', '', {
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  // the logout route sets a dummy value; treat it as no token
